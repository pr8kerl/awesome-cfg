...
beautiful.init("/home/ians/.config/awesome/themes/niceandclean/theme.lua")

-- This is used later as the default terminal and editor to run.
terminal = 'xterm -fa "Envy Code R"'
...
vicious.register(mpdwidget, vicious.widgets.mpd,
    function (widget, args)
        if args["{state}"] == "Stop" then 
            ...
            return '| mpd: '..args["{state}"]..' - '..args["{Artist}"]..' - '.. args["{Title}"]..' '
        end
    end, 10)

battwidget = widget({ type = "textbox", name = "battwidget" })
vicious.register(battwidget, vicious.widgets.bat, " battery: $1 $2% $3 |", 61, "BAT0")
...
awful.hooks.timer.register(30, function () volume("update", tb_volume) end)
